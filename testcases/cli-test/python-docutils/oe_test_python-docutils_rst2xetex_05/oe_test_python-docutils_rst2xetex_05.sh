...
function run_test() {
    ...
    rst2xetex --use-latex-toc testfile.rst test1.tex
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rst2xetex --use-docutils-docinfo testfile.rst test4.tex
    CHECK_RESULT $?
    rst2xetex --use-latex-docinfo testfile.rst test5.tex && grep 'author{TESTER}' test5.tex
    CHECK_RESULT $?
    rst2xetex --topic-abstract testfile.rst test6.tex
    CHECK_RESULT $?
    rst2xetex --use-latex-abstract testfile.rst test7.tex
    CHECK_RESULT $?
