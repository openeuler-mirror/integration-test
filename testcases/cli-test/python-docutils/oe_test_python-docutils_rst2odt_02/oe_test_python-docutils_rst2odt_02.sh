...
function run_test() {
    ...
    rst2odt -r 1 error.rst test1.odt
    CHECK_RESULT $?
    rst2odt -v error.rst test2.odt
    CHECK_RESULT $?
    rst2odt -q error.rst test3.odt
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rst2odt --no-debug error.rst test7_2.odt
    CHECK_RESULT $?
    rst2odt --halt=1 --warnings=warning.log error.rst test8.odt 2>&1 | grep 'due to level-1' && ls warning.log
    CHECK_RESULT $?
    rst2odt --traceback error.rst test9_1.odt
    CHECK_RESULT $?
    rst2odt --no-traceback error.rst test9_2.odt
    CHECK_RESULT $?
