...
function run_test() {
    ...
    rstpep2html -r 1 pep_error.rst test1.html
    CHECK_RESULT $?
    rstpep2html -v pep_error.rst test2.html
    CHECK_RESULT $?
    rstpep2html -q pep_error.rst test3.html
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rstpep2html --no-debug pep_error.rst test7_2.html
    CHECK_RESULT $?
    rstpep2html --halt=2 --warnings=warning.log pep_error.rst test8.html 2>&1 | grep 'due to level-2' && ls warning.log
    CHECK_RESULT $?
    rstpep2html --traceback pep_error.rst test9.html
    CHECK_RESULT $?
    rstpep2html --no-traceback pep_error.rst test10.html
    CHECK_RESULT $?
