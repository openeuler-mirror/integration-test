...
function run_test() {
    ...
    rst2man --title=testtitle testfile.rst test1.man
    CHECK_RESULT $?
    rst2man -g testfile.rst test2.man
    CHECK_RESULT $?
    rst2man --no-generator testfile.rst test3.man
    CHECK_RESULT $?
    ...
    CHECK_RESULT $? 0 1
    rst2man --toc-entry-backlinks testfile.rst test9.man 
    CHECK_RESULT $?
    rst2man --toc-top-backlinks testfile.rst test10.man 
    CHECK_RESULT $?
    rst2man --no-toc-backlinks testfile.rst test11.man
    CHECK_RESULT $? 
    rst2man --no-footnote-backlinks testfile.rst test12_1.man
    CHECK_RESULT $?
    rst2man --footnote-backlinks testfile.rst test12_2.man 
    CHECK_RESULT $?
