...
function run_test() {
    ...
    rst2xml -r 1 error.rst test1.xml
    CHECK_RESULT $?
    rst2xml -v error.rst test2.xml
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rst2xml --halt=1 --warnings=warning.log error.rst test7.xml 2>&1 | grep 'due to level-1' && ls warning.log
    CHECK_RESULT $?
    rst2xml --traceback error.rst test8.xml
    CHECK_RESULT $?
    rst2xml --no-traceback error.rst test9.xml
    CHECK_RESULT $?
