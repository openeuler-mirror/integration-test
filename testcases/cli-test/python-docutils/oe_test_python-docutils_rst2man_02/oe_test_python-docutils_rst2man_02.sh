...
function run_test() {
    ...
    rst2man -r 1 error.rst test1.man
    CHECK_RESULT $?
    rst2man -v error.rst test2.man
    CHECK_RESULT $?
    rst2man -q error.rst test3.man
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rst2man --no-debug error.rst test7_2.man
    CHECK_RESULT $?
    rst2man --halt=1 --warnings=warning.log error.rst test8.man 2>&1 | grep 'due to level-1' && ls warning.log
    CHECK_RESULT $?
    rst2man --traceback error.rst test9_1.man
    CHECK_RESULT $?
    rst2man --no-traceback error.rst test9_2.man
    CHECK_RESULT $?
