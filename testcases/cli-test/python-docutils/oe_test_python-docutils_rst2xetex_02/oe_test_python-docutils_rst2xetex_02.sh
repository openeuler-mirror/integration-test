...
function run_test() {
    ...
    rst2xetex -r 1 error.rst test1.tex
    CHECK_RESULT $?
    rst2xetex -v error.rst test2.tex
    CHECK_RESULT $?
    rst2xetex -q error.rst test3.tex
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rst2xetex --no-debug error.rst test7_2.tex
    CHECK_RESULT $?
    rst2xetex --halt=1 --warnings=warning.log error.rst test8.tex 2>&1 | grep 'due to level-1' && ls warning.log
    CHECK_RESULT $?
    rst2xetex --traceback error.rst test9_1.tex
    CHECK_RESULT $?
    rst2xetex --no-traceback error.rst test9_2.tex
    CHECK_RESULT $?
