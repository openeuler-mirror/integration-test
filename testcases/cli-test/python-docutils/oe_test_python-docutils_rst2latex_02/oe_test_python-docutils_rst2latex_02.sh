...
function run_test() {
    ...
    CHECK_RESULT $?
    rst2latex --halt=1 --warnings=warning.log error.rst test8.tex 2>&1 | grep 'due to level-1' && ls warning.log
    CHECK_RESULT $?
    rst2latex --traceback error.rst test9.tex
    CHECK_RESULT $?
    rst2latex --no-traceback error.rst test9.tex
    CHECK_RESULT $?
