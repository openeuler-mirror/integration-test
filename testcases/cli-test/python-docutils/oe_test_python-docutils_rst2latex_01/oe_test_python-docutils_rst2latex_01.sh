...
function run_test() {
    ...
    CHECK_RESULT $?
    rst2latex -g testfile.rst test2.tex && grep 'href{http://docutils.sourceforge.net/}' test2.tex
    CHECK_RESULT $?
    rst2latex --no-generator testfile.rst test3.tex
    CHECK_RESULT $?
    grep 'href{http://docutils.sourceforge.net/}' test3.tex
    CHECK_RESULT $? 0 1
    rst2latex -d -t testfile.rst test4.tex && grep -E "Generated on: [0-9]+-[0-9]+-[0-9]+ [0-9]+:[0-9]+ UTC" test4.tex
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rst2latex --source-url=http://testpage.org testfile.rst test7.tex && grep 'http://testpage.org' test7.tex
    CHECK_RESULT $?
    ...
    CHECK_RESULT $? 0 1
    rst2latex --strip-comments --leave-comments testfile.rst test14.tex && grep 'so: is this!' test14.tex
    CHECK_RESULT $?
