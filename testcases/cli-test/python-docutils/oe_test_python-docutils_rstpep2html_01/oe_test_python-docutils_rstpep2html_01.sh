...
function run_test() {
    ...
    rstpep2html --title=testtitle pep.rst test1.html
    CHECK_RESULT $?
    ...
    CHECK_RESULT $?
    rstpep2html --toc-top-backlinks pep.rst test10.html && grep 'class="toc-backref" href="#contents"' test10.html
    CHECK_RESULT $?
    rstpep2html --no-toc-backlinks pep.rst test11.html
    CHECK_RESULT $?
    grep 'class="toc-backref" href="#id12"' test11.html
    CHECK_RESULT $? 0 1
    rstpep2html --no-footnote-backlinks pep.rst test12_1.html
    CHECK_RESULT $?
    grep 'class="fn-backref"' test12_1.html
    CHECK_RESULT $? 0 1
    rstpep2html --footnote-backlinks pep.rst test12_2.html && grep 'class="fn-backref"' test12_2.html
    CHECK_RESULT $?
    rstpep2html --strip-comments pep.rst test13.html
    CHECK_RESULT $?
    grep '_so: is this' test13.html
    CHECK_RESULT $? 0 1
    rstpep2html --strip-comments --leave-comments pep.rst test14.html && grep '_so: is this' test14.html
    CHECK_RESULT $?
    rstpep2html --strip-elements-with-class=special pep.rst test15.html
    CHECK_RESULT $?
    grep special test15.html
    CHECK_RESULT $? 0 1
    rstpep2html --strip-class=multiple pep.rst test16.html
    CHECK_RESULT $?
